    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-slate-200 mb-6 print:shadow-none">
          ...
          {/* Rundown List - Grid Layout for Perfect Alignment */}
          <div className="p-6">
            {/* Header Row */}
            <div className="grid gap-6 pb-3 mb-3 border-b-2 border-slate-300" style={{ gridTemplateColumns: '140px 100px 150px 80px 1fr 150px 80px' }}>
            ...
            {items.map((item, index) => {
              ...
              return (
                <div key={item.id} className="group hover:bg-indigo-50 rounded-xl transition-all border-b border-slate-100 last:border-b-0">
                  <div className="grid gap-6 py-4 items-center" style={{ gridTemplateColumns: '140px 100px 150px 80px 1fr 150px 80px' }}>
                    {/* Time */}
                  ...
                  {item.keterangan && (
                    <div className="text-xs text-slate-600 bg-slate-50 rounded px-3 py-2 mb-3" style={{ marginLeft: '140px' }}>
                      💬 {item.keterangan}
                    </div>
                  )}
                </div>
